...
public final class Loaders {
  ...
  public static <T> CacheLoader<String, T> newIdLoader(EntityStoreAsync entityStore, Class<T> type) {
  ...
  public static <T> CacheLoader<String, T> newSecondaryIdLoader(EntityStoreAsync entityStore, String fieldName, Class<T> type) {
    return new CacheLoader<String, T>() {
      @Nullable @Override public T load(String key) {
